...
public class ObjectFactory {
    ...
    private final static QName _TEditSuggestionList_QNAME = new QName("https://www.xscience.com/data/review.xsd", "List");
    private final static QName _TEditSuggestionStyle_QNAME = new QName("https://www.xscience.com/data/review.xsd", "Style");
    ...
    /**
     * Create an instance of {@link Review.PublicationTitle }
     * 
     */
    public Review.PublicationTitle createReviewPublicationTitle() {
        return new Review.PublicationTitle();
    }
    ...
    public JAXBElement<TList> createTEditSuggestionList(TList value) {
        return new JAXBElement<TList>(_TEditSuggestionList_QNAME, TList.class, TEditSuggestion.class, value);
    }
    ...
    public JAXBElement<TStyle> createTEditSuggestionStyle(TStyle value) {
        return new JAXBElement<TStyle>(_TEditSuggestionStyle_QNAME, TStyle.class, TEditSuggestion.class, value);
    }
    ...
    public JAXBElement<TList> createTCommentForEditorList(TList value) {
        return new JAXBElement<TList>(_TEditSuggestionList_QNAME, TList.class, TCommentForEditor.class, value);
    }
    ...
    public JAXBElement<TStyle> createTCommentForEditorStyle(TStyle value) {
        return new JAXBElement<TStyle>(_TEditSuggestionStyle_QNAME, TStyle.class, TCommentForEditor.class, value);
    }
