...
public class ObjectFactory {
    ...
    private final static QName _TUserExpertise_QNAME = new QName("", "expertise");
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "expertise", scope = TUser.class)
    public JAXBElement<List<String>> createTUserExpertise(List<String> value) {
        return new JAXBElement<List<String>>(_TUserExpertise_QNAME, ((Class) List.class), TUser.class, ((List<String> ) value));
    }
